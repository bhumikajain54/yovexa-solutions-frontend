...
import { Save, ArrowLeft, Info, Plus, Trash2, Loader2 } from 'lucide-react';
...
export default function AdminEditAboutPage() {
  ...
  useEffect(() => {
    const fetchAbout = async () => {
      try {
        ...
        console.error('Failed to load about for editing:', err);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSaving(true);
      await aboutService.updateAbout(id, formData);
      ...
      <DeleteModal
        ...
        message={
          formData.isActive ? (
            ...
            `Are you sure you want to delete the About section "${formData.title}"?`
          )
        }
